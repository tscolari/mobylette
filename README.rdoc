...
* ==== stylesheet and javascript helpers - REMOVED on 1.9.0

  Stylesheet and javascript helpers were removed from the gem. There is no need to add this complexity if you can build this by yourself using the other helpers, and views.
