...
When you create custom formats with fall back chains, :iphone for example, you must register them as a Mime::Type:
...
Mobylette 3.0+ comes with a `request_device?` helper. By default only :iphone, :ipad, :ios and :android devices come registered.
